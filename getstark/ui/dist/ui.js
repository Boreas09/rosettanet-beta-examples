...
function init$1(t, e, r, n, o, s, i, l = [-1]) {
  ...
  i && i(a.root);
  let u = !1;
  if (a.ctx = r ? r(t, e.props || {}, (d, h, ...g) => {
    const p = g.length ? g[0] : h;
    return a.ctx && o(a.ctx[d], a.ctx[d] = p) && (!a.skip_bound && a.bound[d] && a.bound[d](p), u && make_dirty(t, d)), h;
  }) : [], a.update(), u = !0, run_all(a.before_update), a.fragment = n ? n(a.ctx) : !1, e.target) {
    if (e.hydrate) {
...
function add_css(t) {
  append_styles(t, "svelte-1hx0tvn", `.sr-only.svelte-1hx0tvn{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;border-width:0}.fixed.svelte-1hx0tvn{position:fixed}.inset-0.svelte-1hx0tvn{inset:0px}.z-40.svelte-1hx0tvn{z-index:40}.z-50.svelte-1hx0tvn{z-index:50}.mx-6.svelte-1hx0tvn{margin-left:1.5rem;margin-right:1.5rem}.mb-4.svelte-1hx0tvn{margin-bottom:1rem}.flex.svelte-1hx0tvn{display:flex}.h-8.svelte-1hx0tvn{height:2rem}.w-8.svelte-1hx0tvn{width:2rem}.w-full.svelte-1hx0tvn{width:100%}.max-w-\\[500px\\].svelte-1hx0tvn{max-width:500px}@keyframes svelte-1hx0tvn-spin{to{transform:rotate(360deg)}}.animate-spin.svelte-1hx0tvn{animation:svelte-1hx0tvn-spin 1s linear infinite}.cursor-pointer.svelte-1hx0tvn{cursor:pointer}.flex-col.svelte-1hx0tvn{flex-direction:column}.items-center.svelte-1hx0tvn{align-items:center}.justify-center.svelte-1hx0tvn{justify-content:center}.justify-between.svelte-1hx0tvn{justify-content:space-between}.gap-3.svelte-1hx0tvn{gap:0.75rem}.rounded-full.svelte-1hx0tvn{border-radius:9999px}.rounded-md.svelte-1hx0tvn{border-radius:0.375rem}.bg-black\\/25.svelte-1hx0tvn{background-color:rgb(0 0 0 / 0.25)}.bg-slate-100.svelte-1hx0tvn{--tw-bg-opacity:1;background-color:rgb(241 245 249 / var(--tw-bg-opacity, 1))}.bg-slate-50.svelte-1hx0tvn{--tw-bg-opacity:1;background-color:rgb(248 250 252 / var(--tw-bg-opacity, 1))}.fill-neutral-600.svelte-1hx0tvn{fill:#525252}.p-3.svelte-1hx0tvn{padding:0.75rem}.p-4.svelte-1hx0tvn{padding:1rem}.text-center.svelte-1hx0tvn{text-align:center}.text-xl.svelte-1hx0tvn{font-size:1.25rem;line-height:1.75rem}.text-neutral-300.svelte-1hx0tvn{--tw-text-opacity:1;color:rgb(212 212 212 / var(--tw-text-opacity, 1))}.antialiased.svelte-1hx0tvn{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}.shadow.svelte-1hx0tvn{--tw-shadow:0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1);--tw-shadow-colored:0 1px 3px 0 var(--tw-shadow-color), 0 1px 2px -1px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.shadow-sm.svelte-1hx0tvn{--tw-shadow:0 1px 2px 0 rgb(0 0 0 / 0.05);--tw-shadow-colored:0 1px 2px 0 var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow)}.filter.svelte-1hx0tvn{filter:var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)}.backdrop-blur-sm.svelte-1hx0tvn{--tw-backdrop-blur:blur(4px);-webkit-backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);backdrop-filter:var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)}.transition-colors.svelte-1hx0tvn{transition-property:color, background-color, border-color, fill, stroke, -webkit-text-decoration-color;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke;transition-property:color, background-color, border-color, text-decoration-color, fill, stroke, -webkit-text-decoration-color;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:150ms}.svelte-1hx0tvn,.svelte-1hx0tvn::before,.svelte-1hx0tvn::after{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-gradient-from-position:  ;--tw-gradient-via-position:  ;--tw-gradient-to-position:  ;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  ;--tw-contain-size:  ;--tw-contain-layout:  ;--tw-contain-paint:  ;--tw-contain-style:  }.svelte-1hx0tvn::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-pan-x:  ;--tw-pan-y:  ;--tw-pinch-zoom:  ;--tw-scroll-snap-strictness:proximity;--tw-gradient-from-position:  ;--tw-gradient-via-position:  ;--tw-gradient-to-position:  ;--tw-ordinal:  ;--tw-slashed-zero:  ;--tw-numeric-figure:  ;--tw-numeric-spacing:  ;--tw-numeric-fraction:  ;--tw-ring-inset:  ;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgb(59 130 246 / 0.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;--tw-blur:  ;--tw-brightness:  ;--tw-contrast:  ;--tw-grayscale:  ;--tw-hue-rotate:  ;--tw-invert:  ;--tw-saturate:  ;--tw-sepia:  ;--tw-drop-shadow:  ;--tw-backdrop-blur:  ;--tw-backdrop-brightness:  ;--tw-backdrop-contrast:  ;--tw-backdrop-grayscale:  ;--tw-backdrop-hue-rotate:  ;--tw-backdrop-invert:  ;--tw-backdrop-opacity:  ;--tw-backdrop-saturate:  ;--tw-backdrop-sepia:  ;--tw-contain-size:  ;--tw-contain-layout:  ;--tw-contain-paint:  ;--tw-contain-style:  }.svelte-1hx0tvn,.svelte-1hx0tvn::before,.svelte-1hx0tvn::after{box-sizing:border-box;border-width:0;border-style:solid;border-color:#e5e7eb}.svelte-1hx0tvn::before,.svelte-1hx0tvn::after{--tw-content:''}:host{line-height:1.5;-webkit-text-size-adjust:100%;tab-size:4;font-family:ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";font-feature-settings:normal;font-variation-settings:normal;-webkit-tap-highlight-color:transparent}h1.svelte-1hx0tvn{font-size:inherit;font-weight:inherit}a.svelte-1hx0tvn{color:inherit;text-decoration:inherit}.svelte-1hx0tvn:-moz-focusring{outline:auto}.svelte-1hx0tvn:-moz-ui-invalid{box-shadow:none}.svelte-1hx0tvn::-webkit-inner-spin-button,.svelte-1hx0tvn::-webkit-outer-spin-button{height:auto}.svelte-1hx0tvn::-webkit-search-decoration{-webkit-appearance:none}.svelte-1hx0tvn::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}h1.svelte-1hx0tvn{margin:0}ul.svelte-1hx0tvn{list-style:none;margin:0;padding:0}[role="button"].svelte-1hx0tvn{cursor:pointer}.svelte-1hx0tvn:disabled{cursor:default}img.svelte-1hx0tvn,svg.svelte-1hx0tvn{display:block;vertical-align:middle}img.svelte-1hx0tvn{max-width:100%;height:auto}.svelte-1hx0tvn{font-family:Nunito, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto,\r
      Oxygen, Ubuntu, Cantarell, Fira Sans, Droid Sans, Helvetica Neue,\r
      sans-serif;-webkit-font-smoothing:antialiased}.hover\\:bg-slate-200.svelte-1hx0tvn:hover{--tw-bg-opacity:1;background-color:rgb(226 232 240 / var(--tw-bg-opacity, 1))}.dark\\:border-neutral-600.svelte-1hx0tvn:is(.dark *){--tw-border-opacity:1;border-color:rgb(82 82 82 / var(--tw-border-opacity, 1))}.dark\\:bg-neutral-800.svelte-1hx0tvn:is(.dark *){--tw-bg-opacity:1;background-color:rgb(38 38 38 / var(--tw-bg-opacity, 1))}.dark\\:bg-neutral-900.svelte-1hx0tvn:is(.dark *){--tw-bg-opacity:1;background-color:rgb(23 23 23 / var(--tw-bg-opacity, 1))}.dark\\:fill-neutral-300.svelte-1hx0tvn:is(.dark *){fill:#d4d4d4}.dark\\:text-neutral-600.svelte-1hx0tvn:is(.dark *){--tw-text-opacity:1;color:rgb(82 82 82 / var(--tw-text-opacity, 1))}.dark\\:text-white.svelte-1hx0tvn:is(.dark *){--tw-text-opacity:1;color:rgb(255 255 255 / var(--tw-text-opacity, 1))}.dark\\:hover\\:bg-neutral-700.svelte-1hx0tvn:hover:is(.dark *){--tw-bg-opacity:1;background-color:rgb(64 64 64 / var(--tw-bg-opacity, 1))}`);
}
...
function create_else_block(t) {
  ...
  return {
    c() {
      e = element("img"), attr(e, "alt", t[23].name), src_url_equal(e.src, r = t[23].icon) || attr(e, "src", r), attr(e, "class", "w-8 h-8 rounded-full svelte-1hx0tvn");
    },
    m(n, o) {
      insert(n, e, o);
    },
...
function create_if_block(t) {
  ...
  return {
    c() {
      e = element("div"), e.innerHTML = `<svg aria-hidden="true" class="w-8 h-8 text-neutral-300 animate-spin dark:text-neutral-600 fill-neutral-600 dark:fill-neutral-300 svelte-1hx0tvn" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z" fill="currentColor" class="svelte-1hx0tvn"></path><path d="M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z" fill="currentFill" class="svelte-1hx0tvn"></path></svg> 
              <span class="sr-only svelte-1hx0tvn">Loading...</span>`, attr(e, "role", "status"), attr(e, "class", "svelte-1hx0tvn");
    },
    m(r, n) {
      insert(r, e, n);
    },
...
function create_each_block_1(t) {
  ...
  return {
    c() {
      e = element("li"), n = text(r), o = space(), a.c(), attr(e, "class", "flex justify-between items-center p-3 bg-slate-100 rounded-md cursor-pointer shadow-sm hover:bg-slate-200 transition-colors dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:border-neutral-600 dark:text-white svelte-1hx0tvn");
    },
    m(h, g) {
      insert(h, e, g), append(e, n), append(e, o), a.m(e, null), s || (i = [
        listen(e, "click", u),
        listen(e, "keyup", d)
      ], s = !0);
    },
    p(h, g) {
      t = h, c === (c = l(t)) && a ? a.p(t, g) : (a.d(1), a = c(t), a && (a.c(), a.m(e, null)));
    },
    d(h) {
      h && detach(e), a.d(), s = !1, run_all(i);
    }
  };
}
function create_each_block(t) {
  let e, r, n = t[20].name + "", o, s, i, l, c, a, u, d, h, g;
  return {
    c() {
      e = element("a"), r = element("li"), o = text(n), s = space(), i = element("img"), a = space(), attr(i, "alt", l = t[20].name), src_url_equal(i.src, c = t[20].icon) || attr(i, "src", c), attr(i, "class", "w-8 h-8 rounded-full svelte-1hx0tvn"), attr(r, "class", "flex justify-between items-center p-3 bg-slate-100 rounded-md shadow-sm cursor-pointer hover:bg-slate-200 transition-colors dark:bg-neutral-800 dark:hover:bg-neutral-700 dark:border-neutral-600 dark:text-white svelte-1hx0tvn"), attr(e, "alt", u = t[20].name + " download link"), attr(e, "href", d = t[20].download), attr(e, "target", "_blank"), attr(e, "rel", "noopener noreferrer"), attr(e, "class", "svelte-1hx0tvn");
    },
    m(p, b) {
      insert(p, e, b), append(e, r), append(r, o), append(r, s), append(r, i), append(e, a), h || (g = [
        listen(r, "click", t[14]),
        listen(r, "keyup", t[15])
      ], h = !0);
    },
    p(p, b) {
      b & 1 && n !== (n = p[20].name + "") && set_data(o, n), b & 1 && l !== (l = p[20].name) && attr(i, "alt", l), b & 1 && !src_url_equal(i.src, c = p[20].icon) && attr(i, "src", c), b & 1 && u !== (u = p[20].name + " download link") && attr(e, "alt", u), b & 1 && d !== (d = p[20].download) && attr(e, "href", d);
    },
    d(p) {
      p && detach(e), h = !1, run_all(g);
    }
  };
}
function create_fragment(t) {
  let e, r, n, o, s, i, l, c, a, u, d, h, g = t[4], p = [];
  for (let m = 0; m < g.length; m += 1)
    p[m] = create_each_block_1(get_each_context_1(t, g, m));
  let b = t[0], w = [];
  for (let m = 0; m < b.length; m += 1)
    w[m] = create_each_block(get_each_context(t, b, m));
  return {
    c() {
      e = element("div"), r = element("main"), n = element("header"), o = element("h1"), o.textContent = "Connect a wallet", s = space(), i = element("span"), i.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 24 24" fill="currentColor" class="svelte-1hx0tvn"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" class="svelte-1hx0tvn"></path></svg>', l = space(), c = element("ul");
      for (let m = 0; m < p.length; m += 1)
        p[m].c();
      a = space();
      for (let m = 0; m < w.length; m += 1)
        w[m].c();
      attr(o, "class", "text-xl svelte-1hx0tvn"), attr(i, "role", "button"), attr(i, "alt", "Close"), attr(i, "class", "cursor-pointer svelte-1hx0tvn"), attr(n, "class", "flex items-center justify-between mb-4 svelte-1hx0tvn"), attr(c, "class", "flex flex-col gap-3 svelte-1hx0tvn"), attr(r, "role", "dialog"), attr(r, "class", null_to_empty("bg-slate-50 rounded-md shadow w-full max-w-[500px] mx-6 p-4 text-center z-50 dark:bg-neutral-900 dark:text-white") + " svelte-1hx0tvn"), attr(e, "class", u = null_to_empty("backdrop-blur-sm fixed inset-0 flex items-center justify-center bg-black/25 z-40 " + t[2]) + " svelte-1hx0tvn");
    },
    m(m, v) {
      insert(m, e, v), append(e, r), append(r, n), append(n, o), append(n, s), append(n, i), append(r, l), append(r, c);
    ...
    p(m, [v]) {
      if (v & 26) {
        ...
        for (y = 0; y < g.length; y += 1) {
          const A = get_each_context_1(m, g, y);
          p[y] ? p[y].p(A, v) : (p[y] = create_each_block_1(A), p[y].c(), p[y].m(c, a));
        }
        for (; y < p.length; y += 1)
          p[y].d(1);
        p.length = g.length;
      ...
      if (v & 9) {
        ...
        for (y = 0; y < b.length; y += 1) {
          const A = get_each_context(m, b, y);
          w[y] ? w[y].p(A, v) : (w[y] = create_each_block(A), w[y].c(), w[y].m(c, null));
        }
        for (; y < w.length; y += 1)
          w[y].d(1);
        w.length = b.length;
      }
      v & 4 && u !== (u = null_to_empty("backdrop-blur-sm fixed inset-0 flex items-center justify-center bg-black/25 z-40 " + m[2]) + " svelte-1hx0tvn") && attr(e, "class", u);
    },
    i: noop,
    o: noop,
    d(m) {
      m && detach(e), destroy_each(p, m), destroy_each(w, m), d = !1, run_all(h);
    }
  };
}
...
function instance(t, e, r) {
  ...
  let { lastWallet: o = null } = e, { installedWallets: s = [] } = e, { authorizedWallets: i = [] } = e, { discoveryWallets: l = [] } = e, { callback: c = async () => {
  } } = e, { theme: a = null } = e, u = !1, d = async (M) => {
    var I;
    r(1, u = (I = M == null ? void 0 : M.id) != null ? I : !1), await c(M).catch(() => {
    }), r(1, u = !1);
  }, h = "";
  a === "dark" || a === null && (n == null ? void 0 : n.matchMedia("(prefers-color-scheme: dark)").matches) ? h = "dark" : h = "";
  const g = (M) => {
    r(2, h = M.matches ? "dark" : "");
  };
  onMount(() => {
    if (a === null)
  ...
  const p = [o, ...i, ...s].filter(Boolean), b = () => d(null), w = (M) => {
    M.key === "Enter" && d(null);
  }, m = (M) => d(M), v = (M, I) => {
    I.key === "Enter" && d(M);
  }, y = () => d(null), A = (M) => {
  ...
  return t.$$set = (M) => {
    "lastWallet" in M && r(5, o = M.lastWallet), "installedWallets" in M && r(6, s = M.installedWallets), "authorizedWallets" in M && r(7, i = M.authorizedWallets), "discoveryWallets" in M && r(0, l = M.discoveryWallets), "callback" in M && r(8, c = M.callback), "theme" in M && r(9, a = M.theme);
  }, [
    l,
    u,
    h,
...
async function show({
  ...
  return new Promise((i) => {
    ...
    n = excludeWallets(n, l), e = excludeWallets(e, [
      ...l,
      ...n
    ]), t = excludeWallets(t, [
      ...l,
    ...
    const c = new Modal({
      ...
      props: {
        ...
        authorizedWallets: n,
        discoveryWallets: t,
        theme: (s == null ? void 0 : s.theme) === "system" ? null : (a = s == null ? void 0 : s.theme) != null ? a : null
      }
    });
  });
}
var te = Object.defineProperty, re = (t, e, r) => e in t ? te(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, O = (t, e, r) => (re(t, typeof e != "symbol" ? e + "" : e, r), r), K = (t, e, r) => {
  if (!e.has(t))
    throw TypeError("Cannot " + r);
}, S = (t, e, r) => (K(t, e, "read from private field"), r ? r.call(t) : e.get(t)), C = (t, e, r) => {
  if (e.has(t))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(t) : e.set(t, r);
}, F = (t, e, r, n) => (K(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r), j = (t, e, r) => (K(t, e, "access private method"), r);
...
function parseHyphen(t) {
  return t.replace(parseRegex(hyphenRange), (e, r, n, o, s, i, l, c, a, u, d, h) => (isXVersion(n) ? r = "" : isXVersion(o) ? r = `>=${n}.0.0` : isXVersion(s) ? r = `>=${n}.${o}.0` : r = `>=${r}`, isXVersion(a) ? c = "" : isXVersion(u) ? c = `<${Number(a) + 1}.0.0-0` : isXVersion(d) ? c = `<${a}.${Number(u) + 1}.0-0` : h ? c = `<=${a}.${u}.${d}-${h}` : c = `<=${c}`, `${r} ${c}`.trim()));
}
...
function parseXRanges(t) {
  return t.split(/\s+/).map((e) => e.trim().replace(parseRegex(xRange), (r, n, o, s, i, l) => {
    const c = isXVersion(o), a = c || isXVersion(s), u = a || isXVersion(i);
    return n === "=" && u && (n = ""), l = "", c ? n === ">" || n === "<" ? "<0.0.0-0" : "*" : n && u ? (a && (s = 0), i = 0, n === ">" ? (n = ">=", a ? (o = Number(o) + 1, s = 0, i = 0) : (s = Number(s) + 1, i = 0)) : n === "<=" && (n = "<", a ? o = Number(o) + 1 : s = Number(s) + 1), n === "<" && (l = "-0"), `${n + o}.${s}.${i}${l}`) : a ? `>=${o}.0.0${l} <${Number(o) + 1}.0.0-0` : u ? `>=${o}.${s}.0${l} <${o}.${Number(s) + 1}.0-0` : r;
  })).join(" ");
}
...
function satisfy(t, e) {
  ...
  for (const u of r) {
    ...
    const [, h, , g, p, b, w] = d, m = {
      operator: h,
      version: combineVersion(g, p, b, w),
      major: g,
      minor: p,
      patch: b,
...
function formatShareConfigs(t, e) {
  ...
  return Object.keys(o).forEach((i) => {
    s[i] ? o[i].forEach((l) => {
      s[i].find((c) => c.version === l.version) || s[i].push(l);
    }) : s[i] = o[i];
  }), {
    shared: s,
    shareInfos: o
...
function getRegisteredShare(t, e, r, n) {
  ...
  for (const c of l)
    if (o && t[c] && t[c][e]) {
      const { requiredVersion: a } = o, u = getFindShareFunction(i)(t, c, e), d = () => {
        if (o.singleton) {
          if (typeof a == "string" && !satisfy(u, a)) {
            const g = `Version ${u} from ${u && t[c][e][u].from} of shared singleton module ${e} does not satisfy the requirement of ${r.from} which needs ${a})`;
          ...
          if (a === !1 || a === "*" || satisfy(u, a))
            return t[c][e][u];
          for (const [g, p] of Object.entries(t[c][e]))
            if (satisfy(g, a))
              return p;
        }
      }, h = {
...
function getTargetSharedOptions(t) {
  const { pkgName: e, extraOptions: r, shareInfos: n } = t, o = (l) => {
    ...
    const a = findVersion(c, function(u, d) {
...
function generateSnapshotFromManifest(t) {
  var e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r, n, o = e.remotes, s = o === void 0 ? {} : o, i = e.overrides, l = i === void 0 ? {} : i, c = e.version, a, u = function() {
  ...
  if (!Object.keys(s).length) {
    var g;
    h = ((g = t.remotes) === null || g === void 0 ? void 0 : g.reduce(function(_, T) {
      var G, H = T.federationContainerName;
      return d.includes(H) ? G = l[H] : "version" in T ? G = T.version : G = T.entry, _[H] = {
        matchedVersion: G
      }, _;
    }, {})) || {};
  }
  Object.keys(s).forEach(function(_) {
    return h[_] = {
      matchedVersion: d.includes(_) ? l[_] : s[_]
    };
  });
  var p = t.metaData, b = p.remoteEntry, w = b.path, m = b.name, v = b.type, y = p.types, A = p.buildInfo.buildVersion, x = p.globalName, N = t.exposes, M = {
    version: c || "",
    buildVersion: A,
    globalName: x,
    remoteEntry: simpleJoinRemoteEntry(w, m),
    remoteEntryType: v,
    remoteTypes: simpleJoinRemoteEntry(y.path, y.name),
    remoteTypesZip: y.zip || "",
    remoteTypesAPI: y.api || "",
    remotesInfo: h,
    shared: t == null ? void 0 : t.shared.map(function(_) {
      return {
        assets: _.assets,
        sharedName: _.name,
        version: _.version
    ...
    modules: N == null ? void 0 : N.map(function(_) {
      return {
        moduleName: _.name,
        modulePath: _.path,
        assets: _.assets
  ...
  if (!((r = t.metaData) === null || r === void 0) && r.prefetchInterface) {
    var I = t.metaData.prefetchInterface;
    M = _object_spread_props(_object_spread$2({}, M), {
      prefetchInterface: I
    });
  }
  if (!((n = t.metaData) === null || n === void 0) && n.prefetchEntry) {
    var E = t.metaData.prefetchEntry, D = E.path, Q = E.name, V = E.type;
    M = _object_spread_props(_object_spread$2({}, M), {
      prefetchEntry: simpleJoinRemoteEntry(D, Q),
      prefetchEntryType: V
    });
  }
  return "publicPath" in t.metaData ? a = _object_spread_props(_object_spread$2({}, M), {
    publicPath: u()
  }) : a = _object_spread_props(_object_spread$2({}, M), {
    getPublicPath: u()
  }), a;
}
...
function createScript(t) {
  ...
  var d = function(h, g) {
    ...
    if (clearTimeout(o), e && (e.onerror = null, e.onload = null, safeWrapper(function() {
      var m = t.needDeleteScript, v = m === void 0 ? !0 : m;
      v && e != null && e.parentNode && e.parentNode.removeChild(e);
    }), h)) {
      var b, w = h(g);
      return t == null || (b = t.cb) === null || b === void 0 || b.call(t), w;
    }
...
function createLink(t) {
  ...
  if (!e) {
    ...
    a && Object.keys(a).forEach(function(d) {
      e && !e.getAttribute(d) && e.setAttribute(d, a[d]);
    });
  }
  var u = function(d, h) {
    if (e && (e.onerror = null, e.onload = null, safeWrapper(function() {
      var p = t.needDeleteLink, b = p === void 0 ? !0 : p;
      b && e != null && e.parentNode && e.parentNode.removeChild(e);
    }), d)) {
      var g = d(h);
      return t.cb(), g;
    }
...
let Module = class {
 ...
 ${safeToString$1(this.remoteInfo)}`), this.remoteEntryExports = t, this.remoteEntryExports;
  ...
  async get(t, e, r) {
    ...
    if (!this.inited) {
      const l = this.host.shareScopeMap, c = this.remoteInfo.shareScope || "default";
      l[c] || (l[c] = {});
      const a = l[c], u = [], d = {
...
function generatePreloadAssets(t, e, r, n, o) {
  const s = [], i = [], l = [], c = /* @__PURE__ */ new Set(), a = /* @__PURE__ */ new Set(), { options: u } = t, { preloadConfig: d } = e, { depsRemote: h } = d;
  if (traverseModuleInfo(n, r, (p, b, w) => {
    let m;
    if (w)
      m = d;
    else if (Array.isArray(h)) {
      const M = h.find((I) => I.nameOrAlias === b.name || I.nameOrAlias === b.alias);
      if (!M)
        return;
      m = defaultPreloadArgs(M);
    } else if (h === !0)
      m = d;
    else
      return;
    const v = getResourceUrl(p, "remoteEntry" in p ? p.remoteEntry : "");
    v && l.push({
      name: b.name,
      moduleInfo: {
        name: b.name,
        ...
        entryGlobalName: "globalName" in p ? p.globalName : b.name,
        shareScope: "",
    ...
    const A = normalizePreloadExposes(m.exposes);
    if (A.length && "modules" in p) {
      var x;
      y = p == null || (x = p.modules) == null ? void 0 : x.reduce((M, I) => ((A == null ? void 0 : A.indexOf(I.moduleName)) !== -1 && M.push(I), M), []);
    }
    function N(M) {
      const I = M.map((E) => getResourceUrl(p, E));
      return m.filter ? I.filter(m.filter) : I;
    }
    if (y) {
      const M = y.length;
      for (let I = 0; I < M; I++) {
        const E = y[I], D = `${b.name}/${E.moduleName}`;
        t.remoteHandler.hooks.lifecycle.handlePreloadModule.emit({
          id: E.moduleName === "." ? b.name : D,
          name: b.name,
          remoteSnapshot: p,
          preloadConfig: m,
          remote: b,
          origin: t
        }), !getPreloaded(D) && (m.resourceCategory === "all" ? (s.push(...N(E.assets.css.async)), s.push(...N(E.assets.css.sync)), i.push(...N(E.assets.js.async)), i.push(...N(E.assets.js.sync))) : (m.resourceCategory = "sync") && (s.push(...N(E.assets.css.sync)), i.push(...N(E.assets.js.sync))), setPreloaded(D));
      }
    }
  }, !0, {}, o), o.shared) {
    const p = (b, w) => {
      const m = getRegisteredShare(t.shareScopeMap, w.sharedName, b, t.sharedHandler.hooks.lifecycle.resolveShare);
      m && typeof m.lib == "function" && (w.assets.js.sync.forEach((v) => {
        c.add(v);
      }), w.assets.css.sync.forEach((v) => {
        a.add(v);
      }));
    };
    o.shared.forEach((b) => {
      var w;
      const m = (w = u.shared) == null ? void 0 : w[b.sharedName];
      if (!m)
        return;
      const v = b.version ? m.find((y) => y.version === b.version) : m;
      !v || arrayOptions(v).forEach((y) => {
        p(y, b);
      });
    });
  }
  const g = i.filter((p) => !c.has(p));
  return {
  ...
  async loadRemoteSnapshotInfo(e) {
    ...
    if (l)
      if (isManifestProvider(l)) {
        const a = await this.getManifestJson(l.remoteEntry, e, {}), u = setGlobalSnapshotInfoByModuleInfo(_extends$3({}, e, {
          entry: l.remoteEntry
        }), a);
        return {
          remoteSnapshot: a,
      ...
      const a = await this.getManifestJson(e.entry, e, {}), u = setGlobalSnapshotInfoByModuleInfo(e, a), { remoteSnapshot: d } = await this.hooks.lifecycle.loadRemoteSnapshot.emit({
        options: this.HostInstance.options,
        moduleInfo: e,
        remoteSnapshot: a,
        from: "global"
...
class SharedHandler {
  ...
  initializeSharing(e = DEFAULT_SCOPE, r) {
    ...
    const i = o[e], l = (d, h) => {
      var g;
      const { version: p, eager: b } = h;
      i[d] = i[d] || {};
      const w = i[d], m = w[p], v = Boolean(m && (m.eager || ((g = m.shareConfig) == null ? void 0 : g.eager)));
      (!m || m.strategy !== "loaded-first" && !m.loaded && (Boolean(!b) !== !v ? b : s > m.from)) && (w[p] = h);
    }, c = [], a = (d) => d && d.init && d.init(o[e]), u = async (d) => {
  ...
  setShared({ pkgName: e, shared: r, from: n, lib: o, loading: s, loaded: i, get: l }) {
    const { version: c, scope: a = "default" } = r, u = _object_without_properties_loose(r, [
      "version",
      "scope"
    ]);
    (Array.isArray(a) ? a : [
...
class RemoteHandler {
  ...
  async loadRemote(e, r) {
    ...
    try {
      const { loadFactory: o = !0 } = r || {
        ...
        id: e
      }), { pkgNameOrAlias: c, remote: a, expose: u, id: d } = l, h = await s.get(d, u, r), g = await this.hooks.lifecycle.onLoad.emit({
        id: d,
        pkgNameOrAlias: c,
        expose: u,
  ...
  async getRemoteModuleAndOptions(e) {
    ...
    return h || (h = new Module(g), r.moduleCache.set(u.name, h)), {
      module: h,
      moduleOptions: g,
      remoteMatchInfo: a
    };
  ...
  removeRemote(e) {
    ...
    if (s) {
      ...
      let u = l.buildVersion ? composeKeyWithSeparator(l.name, l.buildVersion) : l.name;
      const d = globalThis.__FEDERATION__.__INSTANCES__.findIndex((h) => l.buildVersion ? h.options.id === u : h.name === u);
      if (d !== -1) {
        ...
        Object.keys(g).forEach((w) => {
          Object.keys(g[w]).forEach((m) => {
            Object.keys(g[w][m]).forEach((v) => {
              Object.keys(g[w][m][v]).forEach((y) => {
                const A = g[w][m][v][y];
                A.from === l.name && (A.loaded || A.loading ? (A.useIn = A.useIn.filter((x) => x !== l.name), A.useIn.length ? p = !1 : b.push([
                  w,
                  m,
                  v,
                  y
        ...
        }), p && (h.shareScopeMap = {}, delete g[u]), b.forEach(([w, m, v, y]) => {
          var A, x, N;
          (N = g[w]) == null || (x = N[m]) == null || (A = x[v]) == null || delete A[y];
...
B = /* @__PURE__ */ new WeakSet(), Z = async function(t) {
...
}, R = /* @__PURE__ */ new WeakSet(), U = async function(t = window) {
  return this.lock.runExclusive(async () => (this.swo || (this.swo = await j(this, B, Z).call(this, t), j(this, Y, J).call(this)), this.swo));
...
const wallets = [
  ...
  },
  {
    ...
    downloads: {
      ...
      android: `https://link.braavos.app/dapp/${(q = ssrSafeWindow$1 == null ? void 0 : ssrSafeWindow$1.location) == null ? void 0 : q.host}`
    }
  },
  {
    id: "metamasksnaps",
...
class LocalStorageWrapper {
  constructor(e) {
    C(this, $), C(this, k), C(this, z, !1), C(this, L, void 0), C(this, P, void 0), O(this, "value"), F(this, P, e), j(this, k, W).call(this);
  }
  set(e) {
...
z = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakSet(), ee = function() {
...
function getStarknet(t = {}) {
  ...
  return i(), {
    ...
    getLastConnectedWallet: async () => {
      const l = o.get(), c = scanObjectForWallets(r, n).find(
        (u) => u.id === l
...
class Utils {
  ...
  static compareVersions(e, r, n = !1) {
    ...
    let i = Math.max(o, s), l = 0;
    const c = Utils.map([e, r], (a) => {
      const u = i - Utils.getVersionPrecision(a), d = a + new Array(u + 1).join(".0");
...
class Parser {
  ...
  satisfies(e) {
    ...
    if (Object.keys(e).forEach((l) => {
      const c = e[l];
      typeof c == "string" ? (o[l] = c, s += 1) : typeof c == "object" && (r[l] = c, n += 1);
    }), n > 0) {
      const l = Object.keys(r), c = Utils.find(l, (u) => this.isOS(u));
      if (c) {
    ...
    if (s > 0) {
      const l = Object.keys(o), c = Utils.find(l, (a) => this.isBrowser(a, !0));
      if (c !== void 0)
...
const enableWithVersion = async (t, e) => t ? main.enable(t, e).catch(() => null) : null, connect = async ({
  ...
  if (t === "neverAsk") {
    const h = (u = s.find((g) => g.id === (i == null ? void 0 : i.id))) != null ? u : s[0];
    return enableWithVersion(h, { silent_mode: !0 });
  }
  const l = await main.getAvailableWallets(o);
  if (t === "canAsk" && i) {
    const h = (d = s.find((g) => g.id === (i == null ? void 0 : i.id))) != null ? d : l.length === 1 ? l[0] : void 0;
    if (h)
      return enableWithVersion(h);
  }
  const a = (await main.getDiscoveryWallets(o)).reduce((h, g) => {
    const p = g.downloads[r] || g.downloads[e];
    if (p) {
      const b = Object.keys(g.downloads).find(
        (v) => g.downloads[v] === p
      ), m = b === "android" || b === "ios" ? `${g.name} Mobile` : `Install ${g.name}`;
      h.push({ ...g, name: m, download: p });
    }
    return h;
  }, []);
  return show({
